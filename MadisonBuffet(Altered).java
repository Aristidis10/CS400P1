...
public class MadisonBuffet implements MapADT<String, Double> {
    ...
    public boolean put(String key, Double value) throws NoSuchElementException {
        ...
        restaurants.add(new Restaurant(key, value)); //add restaurant to the list for sorting.
    ...
    public Double remove(String key) {
        ...
        restaurants.remove(key); // remove restaurant from list for sorting
...
//    }
    ...
    {
        String rank = "";
        restaurants.sort((r1,r2) -> Double.compare(r1.rating,r2.rating));
        for(Restaurant r: restaurants)
        {
            rank += showName(r.name);
        }
        return rank;
    }
